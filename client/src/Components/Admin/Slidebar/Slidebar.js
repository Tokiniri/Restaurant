  ...
  return (
        ...
        <div className='bg-transparent sidebar p-2'>
            ...
            <div className='list-group list-group-flush text-white'>
                ...
                <Link to={"/admin/commande"} className='list-group-item list-group-item-action py-2 my-1'>
                    <MdManageHistory className=' fs-5 me-3'/><span >Historique Commade</span>                
                </Link>
                <Link to={"/admin/commandes"} className='list-group-item list-group-item-action py-2 my-1'>
                    <FaRegClipboard className=' fs-5 me-3'/><span >Commade</span>                
                </Link>
            ...
            <div className='ModalLougot'> 
                ...
                <div className="button-container">
                    <button onClick={toggleModal} className='btn btn-success text-white' style={{ display: 'inline-block' }}>Annuler</button>                    
                    <Link to={"/"} style={{marginLeft:"1%", backgroundColor:"red" }} className='btn btn-danger text-white'>Logout</Link>
                </div>

...
const handleDelete = (e) => {
  ...
  axios.delete(`http://localhost:8081/deleteEntre/${id}`)
  .then(response => {
  ...
  return (
    <div>
      {supprimer && (
        <div>
            <div className='ModalSupprimerBoisson'>
              ...
              <h2 className='text-center' style={{fontSize:"1.4rem"}}>Êtes-vous sûr de vouloir supprimer cet élément ?</h2>
      ...
      {modal && (         
            <div className='ModalModifierEntre'>
                  <form onSubmit={handleUpdate}>
                    ...
                    <br/>
                    <button style={{color:"white"}} className='btn btn-info me-2'>Submit</button>
                     <button to={"/produits"} 
                ...
                <table className="table">
                  ...
                  <tbody>
                    ...
                    <tr key={index}>
                        ...
                        <div className="flex items-center gap-3">
                          <div className="avatar">
                            <div className="mask mask-squircle w-12 h-12">
                              <img src={entre.image} style={{with:"100px", height:"100px"}} alt={entre.nom} />
                            </div>
                          </div>
                          <div>
                      ...
                      <td>
                        <button className="btn btn-ghost btn-xs">{entre.prix}</button>
                      </td>
                      <td>
                        <div style={{ display: "flex", alignItems: "center" , marginTop:"10%"}}>
                          <FaPenToSquare onClick={(e) => toggleModal(entre.id)} style={{ color: "blue", width: "24px", height: "24px", cursor: "pointer" }} />
                          <MdDelete onClick={() => toggleSupprimer(entre.id)}  style={{ color: "red", width: "24px", height: "24px", cursor: "pointer", marginLeft: "10px" }} /> 
                        </div>
                      </td>
                    </tr>
                    ))

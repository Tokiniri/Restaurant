...
//                               <img src={pizza.image} style={{with:"50px", height:"50px"}} alt={pizza.nom} />
//                             </div>
//                           </div>
//                           <div>
...
//                       <th>
//                         <button className="btn btn-ghost btn-xs">{pizza.prix}</button>
//                       </th>
//                       <th>
//                         <div style={{ display: "flex", alignItems: "center" , marginTop:"10%"}}>
//                           <FaPenToSquare onClick={toggleModal} style={{ color: "blue", width: "24px", height: "24px", cursor: "pointer" }} />
...
const handleDelete = (e) => {
  ...
  axios.delete(`http://localhost:8081/deletePizza/${id}`)
  .then(response => {
  ...
  return (
    <div>
      ...
      {modal && (         
            <div className='ModalModifierPizza'>
                ...
                <table className="table">
                  ...
                  <tbody>
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <div style={{ display: "flex", alignItems: "center" , marginTop:"10%"}}>
                          <FaPenToSquare onClick={(e) => toggleModal(pizza.id)} style={{ color: "blue", width: "24px", height: "24px", cursor: "pointer" }} />
                          <MdDelete onClick={() => toggleSupprimer(pizza.id)}  style={{ color: "red", width: "24px", height: "24px", cursor: "pointer", marginLeft: "10px" }} /> 
                        </div>
                      </td>
                    </tr>
                    ))

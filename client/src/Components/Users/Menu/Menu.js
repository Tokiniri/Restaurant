...
import Fontpizza from './Fontpizza/Fontpizza'
import Typemenu from './Typemenu/Typemenu'
import Sakafo from './Sakafo/Sakafo'
...
function Menu() {
  return (
    <div>
        ...
        <Fontpizza/>
        <Typemenu/>
        <footer className="footer items-center p-4 bg-neutral text-neutral-content" style={{backgroundColor:"#bf5700"}}>
  <aside className="items-center grid-flow-col">
    ...
    <p>Fastfood © 2024 - by Toky & Santatra & Tsiry</p>
  </aside> 

...
const Navbar1 = ({size}) => {
  return (
    ...
    <div className="navbar bg-orange-200 text-primary-content justify-center"
     style={{height:"100px", width:"auto" , backgroundColor:"white", color:"#bf5700"}}>
      ...
      style={{ marginRight:"20%" , marginBottom:"-1%"}} >
        <li><Link to={"/Acceuil"} className='text-decoration-none' style={{color:"#bf5700", fontFamily:"cursive", fontSize:"1.5rem"}}>Acceuil</Link></li>
        <li><Link to={"/Menu"} className='text-decoration-none' style={{color:"#bf5700", fontFamily:"cursive", fontSize:"1.5rem"}}>Notre Carte</Link></li>
        <li><Link to={"/Contact"} className='text-decoration-none' style={{color:"#bf5700", fontFamily:"cursive", fontSize:"1.5rem"}}>Contact</Link></li>
      </ul>
      <div className="dropdown dropdown-end " style={{marginRight:"2%", marginBottom:"-1%" }}>
        <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
          <div className="indicator">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 "style={{color:"#bf5700"}} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" /></svg>
            {/* <span className="badge badge-sm indicator-item" style={{padding:"2%", color:"#bf5700"}}>{size}</span> */}
          </div>
        </div>
        <div tabIndex={0} className="mt-3 z-[1] card card-compact dropdown-content w-52 bg-base-100 shadow">
          <div className="card-body bg-orange-100">
            ...
            <div className="card-actions">
              ...
              <Link to={"/purchase-history"} className="btn btn-primary btn-block">View historique</Link>
